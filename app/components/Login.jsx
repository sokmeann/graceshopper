...
const LoginForm = ({login}) => {
  return (
    <div className="container">
      <div className="row">
        <form
          className="form-signin mg-btm form-group"
          onSubmit={evt => {
            evt.preventDefault()
        ...
        <img id="logo" src="/images/DRYgoods.png" width="399" />
        <div className="social-box">
          <div className="row mg-btm">
            ...
            <div className="row">
              <div className="col-md-12">
                <a href="#" className="btn btn-info btn-block" ><i className="icon-twitter" />    Login with Twitter</a>
              </div>
            </div>
          </div>
          <div className="main">
